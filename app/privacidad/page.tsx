  ...
  return (
    <SiteShell>
      <main id="contenido" className="legal-page container">
        ...
        <section><h2>Información privada y catálogo público</h2><p>Los datos privados del propietario no se muestran públicamente. Teléfono, email, cédula, padrón, matrícula y documentación privada nunca forman parte automática del catálogo. Las fotografías enviadas permanecen privadas hasta que NERO aprueba una publicación.</p></section>
