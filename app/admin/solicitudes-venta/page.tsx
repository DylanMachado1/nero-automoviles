...
export default async function Page() {
  ...
  return (
    <main className="admin-content">
      ...
      <div className="admin-table"><table><thead><tr><th>Propietario</th><th>Vehículo</th><th>Ubicación</th><th>Precio</th><th>Fotos</th><th>Fecha</th><th>Gestión</th></tr></thead><tbody>
        {rows.map((row) => {
          ...
          return <tr key={row.id}>
            ...
            <td><EntityActions id={row.id} type="seller" status={row.status} options={['NUEVA', 'CONTACTADO', 'ACEPTADO', 'RECHAZADO']} convert={!row.converted_vehicle_id} /></td>
          </tr>;
        })}
