  ...
  return (
    <SiteShell>
      <main id="contenido" className="legal-page container">
        ...
        <section><h2>3. Comisión</h2><p>NERO cobra una comisión del 4% sobre el precio final de venta únicamente cuando la operación se concreta con un comprador conseguido o gestionado por NERO.</p><p>Si la operación incluye una permuta o un vehículo entregado como parte de pago, la comisión se calcula sobre el valor total acordado de la operación, incluyendo el efectivo y el valor atribuido al vehículo entregado, y no solamente sobre el importe pagado en dinero.</p><p>Si el propietario vende el vehículo por su cuenta a una persona que no fue presentada ni gestionada por NERO, no corresponde comisión. No existe costo por adelantado por solicitar la comercialización.</p></section>
