export const BRAND={name:'NERO Automóviles',slogan:'Tu auto. Nuestra gestión.',instagram:'https://www.instagram.com/nero.automoviles/',instagramHandle:'@nero.automoviles',logoPath:'/brand/nero-logo.webp'} as const;
